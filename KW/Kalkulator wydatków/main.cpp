...
HWND hHistoria = CreateWindowW(L"MojaHistoriaKlasa",L"HISTORIA", WS_VISIBLE | WS_OVERLAPPEDWINDOW, 400, 400, 500, 300, hWnd, NULL, NULL, NULL);
    ...
    hSzukajDochod = CreateWindowW(L"Button",L"Szukaj Dochód", WS_VISIBLE | WS_CHILD,200,20,100,40, hHistoria,(HMENU)SZUKAJ_DOCHOD,NULL,NULL);
    hSzukajWydatek =  CreateWindowW(L"Button",L"Szukaj Wydatek", WS_VISIBLE | WS_CHILD,200,50,100,40, hHistoria,NULL,NULL,NULL);

    hKasuj = CreateWindowW(L"Button",L"Kasuj", WS_VISIBLE | WS_CHILD,200,100,100,40, hHistoria,NULL,NULL,NULL);
